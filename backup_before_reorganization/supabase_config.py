...
SUPABASE_CONFIG = {
    "url": os.getenv("SUPABASE_URL", "https://lszhrgyiwekndcsnibcj.supabase.co"),
    "key": os.getenv("SUPABASE_ANON_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxzemhyZ3lpd2VrbmRjc25pYmNqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI0MzgwNzQsImV4cCI6MjA2ODAxNDA3NH0.zoXJswUFoa7wagv9Y8t19bDYyB3N166NH1Pg6cmeGXs"),
    "service_role_key": os.getenv("SUPABASE_SERVICE_ROLE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxzemhyZ3lpd2VrbmRjc25pYmNqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MjQzODA3NCwiZXhwIjoyMDY4MDE0MDc0fQ.otv7jZ6kojzSHNDGMd__ez9Ta5bkSBRSF3_je7NVAK8")
}
